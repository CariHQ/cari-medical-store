      ...
      <div className="flex flex-col gap-8 transition-all ease-in-out delay-150  ">
         <Container className="flex flex-col gap-2 w-fit">
            <div className="flex justify-between">
               <Heading level="h2">Cari Medical Demo Mode</Heading>
               <IconButton
            ...
            <Text className="text-left">
               This is a demo of Cari Medical, a food delivery platform template
               built with Medusa 2.0 and Next.js.
            </Text>
            <Text className="text-left">
            ...
            <ol className="list-decimal list-inside ml-2 txt-compact-medium">
               <li>
                  Select a vendor, add some food to your cart and complete the
                  checkout form.
               </li>
               <li>In a new tab, log in as a vendor and accept the order.</li>
               <li>
                  In a different incognito tab, log in as a driver and claim the
                  delivery.
               </li>
               <li>
                  You can now go back and forth between the driver and vendor
                  tabs to complete the delivery.
               </li>
            </ol>
            <Link
               href="https://github.com/medusajs/cari-medical-store"
