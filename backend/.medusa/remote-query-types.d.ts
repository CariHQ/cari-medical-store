...
export type Product = {
  ...
  vendor_link?: Maybe<LinkVendorModuleVendorProductProduct>;
  vendor?: Maybe<Vendor>;
};
...
export type Vendor = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  delivery_link?: Maybe<Array<Maybe<LinkVendorModuleVendorDeliveryModuleDelivery>>>;
  deliveries?: Maybe<Array<Maybe<Delivery>>>;
  product_link?: Maybe<Array<Maybe<LinkVendorModuleVendorProductProduct>>>;
  products?: Maybe<Array<Maybe<Product>>>;
};
...
export enum DeliveryDeliveryStatusEnum {
  ...
  VendorPreparing = 'VENDOR_PREPARING',
...
export type Delivery = {
  ...
  order?: Maybe<Order>;
  vendor_link?: Maybe<LinkVendorModuleVendorDeliveryModuleDelivery>;
  vendor?: Maybe<Vendor>;
};
...
export type LinkVendorModuleVendorDeliveryModuleDelivery = {
  __typename?: 'LinkVendorModuleVendorDeliveryModuleDelivery';
...
export type LinkVendorModuleVendorProductProduct = {
  __typename?: 'LinkVendorModuleVendorProductProduct';
  vendor_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  product?: Maybe<Product>;
  createdAt: Scalars['String']['output'];
